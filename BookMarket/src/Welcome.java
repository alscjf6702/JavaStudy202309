...
//			System.out.println("***********************************************");
			...
			if (n > 9 || n < 1) {
				System.out.println("1~9사이의 메뉴를 입력해주세요.");
			}
...
//		System.out.println("장바구니에 항목 추가하기 : ");
		...
		while (!quit) {
			...
			boolean flag = false;
			int numId = -1;
			//-1은 큰 의미는 없고 , data가 없다 라고 생각하면 됨
			...
			if (flag) {
				...
				if (str.toUpperCase().equals("Y")) {
					System.out.println(book[numId][0] + "도서 목록이 추가 되었습니다.");
